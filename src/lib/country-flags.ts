...
export const COUNTRY_CODE_MAP: Record<string, string> = {
  ...
  // Equipes / Construtores (País de Licença Oficial FIA)
  mercedes: 'DEU',
  'mercedes-amg': 'DEU',
  'mercedes-amg petronas': 'DEU',
  ferrari: 'ITA',
  ...
  audi: 'DEU',
  'audi f1 team': 'DEU',
  'audi revolut f1 team': 'DEU',
  'aston martin': 'GBR',
  'aston martin aramco': 'GBR',
  alpine: 'FRA',
  'alpine f1 team': 'FRA',
  haas: 'USA',
  'haas f1 team': 'USA',
  ...
  vcarb: 'ITA',
  'racing bulls': 'ITA',
  'visa cash app rb': 'ITA',
  andretti: 'USA',
  'andretti global': 'USA',
  cadillac: 'USA',
  'cadillac f1 team': 'USA',
  sauber: 'CHE',
  'stake f1 team': 'CHE',
  porsche: 'DEU',
  'porsche motorsport': 'DEU',
  honda: 'JPN',
  'honda hrc': 'JPN',
  'honda hrc f1 team': 'JPN',
  toyota: 'JPN',
  'toyota gazoo racing': 'JPN',
  renault: 'FRA',
  fittipaldi: 'BRA',
  jordan: 'IRL',
  toleman: 'GBR',
