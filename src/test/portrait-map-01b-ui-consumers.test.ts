/**
 * portrait-map-01b-ui-consumers.test.ts
 *
...
import { OfficialRaceResult } from '@/types/canonical-race-v2'
...
describe('PORTRAIT-MAP-01B: Homologação dos Consumidores de Retrato na UI (PM01B-01..12)', () => {
  ...
  it('PM01B-01: PodiumVisualCard renderiza retratos dos pilotos do pódio via resolver canônico', () => {
    const mockResult: any = {
      ...
      officializedAt: '2026-03-15T15:00:00Z',
      totalLaps: 57,
      winnerDriverId: 'mbj-006', // Piastri
      winnerTeamId: 'mclaren',
      poleDriverId: 'mbj-005',
      podium: ['mbj-006', 'mbj-005', 'mbj-007'],
    ...
    render(React.createElement(PodiumVisualCard, { result: mockResult }))
  ...
  it('PM01B-04: OfficialRaceResultPanel renderiza o vencedor e os carros do jogador com fotos canônicas', () => {
    ...
    const entryNorris = {
      ...
      finalPosition: 2,
      pointsAwarded: 18,
      totalTimeFormatted: '1h 25m 02s',
      gapToLeaderFormatted: '+2.000s',
      bestLapFormatted: '1:30.500',
      pitStops: 1,
      dnf: false,
      positionsGainedLost: 0,
      fastestLap: false,
      isPlayer: true,
      carSlot: 'car2' as const,
    }

    const mockResult: any = {
      officialResultId: 'res_test_winner',
      schemaVersion: '2.1.0',
      careerId: 'car_test_2',
      season: 2026,
      round: 2,
      ...
      playerTeamId: 'mclaren',
      officializedAt: '2026-03-22T17:00:00Z',
      totalLaps: 50,
      winnerDriverId: 'mbj-006',
      winnerTeamId: 'mclaren',
      poleDriverId: 'mbj-006',
      podium: ['mbj-006', 'mbj-005', 'mbj-007'],
      winnerDriverName: 'Oscar Piastri',
      winnerTeamName: 'McLaren',
      resultHash: 'hash_test_123',
      entries: [entryPiastri, entryNorris],
      playerEntries: [entryPiastri, entryNorris],
      eventsSummary: {},
    }

    render(
      React.createElement(OfficialRaceResultPanel, {
        result: mockResult,
