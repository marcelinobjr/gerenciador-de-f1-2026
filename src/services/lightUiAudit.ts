...
export const AUDITED_ROUTES: RouteAuditRecord[] = [
  ...
  },
  {
    ...
    complexity: 'BAIXA',
    notes:
      'Totalmente em legado escuro (#0B0E14, card #11161F, borda #1F2733, inputs pretos). Precisa migrar para card branco e fundo off-white executivo.',
  },
  {
    path: '/lobby',
    ...
    complexity: 'ALTA',
    notes:
      'Ambiente envolto pelo LobbyLayout (#0B0E14). Os 7 steps do wizard (Start, Manager, Universe, OfficialTeam, CustomGrid, Settings, Review) são 100% escuros com #11161F.',
  },
  {
    ...
    priority: 'P1',
    complexity: 'ALTA',
    notes: 'Renderiza o LobbyPage dentro do LobbyLayout. Segue a mesma classificação do Lobby.',
  },
  {
    path: '/team',
...
export const AUDITED_PAGES: PageAuditRecord[] = [
  ...
  },
  {
    ...
    priority: 'P1',
    notes:
      'Fundo da tela #0B0E14, card central #11161F, inputs com bg-[#0B0E14]. Precisa de card branco e fundo #F4F5F7.',
  },
  {
    name: 'LobbyPage',
    ...
    priority: 'P1',
    notes:
      'Envolve o fluxo de onboarding completo. Usa LobbyLayout escuro e todos os 7 steps (Start, Manager, Universe, OfficialTeam, CustomGrid, Settings, Review) com estilos escuros.',
  },
  {
    ...
    priority: 'P2',
    notes:
      'Página standalone legada de seleção de equipes, 100% escura (#0B0E14/#11161F). Pode ser migrada ou alinhada ao Lobby.',
  },
  {
    name: 'TeamPage',
...
export const HIGH_LEVERAGE_COMPONENTS: ComponentAuditRecord[] = [
  ...
  },
  {
    ...
    notes:
      'Modal de configurações gerais do jogo usa bg-[#11161F] e border-[#1F2733]. Migrar para modal branco com abas claras.',
  },
  {
    name: 'LobbyLayout',
    ...
    notes:
      'Layout base de todo o ambiente pré-jogo. Topbar #11161F, fundo #0B0E14 e rodapé #11161F. Migrando o shell, o ambiente ganha a identidade limpa.',
  },
  {
    name: 'DecisionModals',
...
export const DARK_SCREENS_EXPLICT_LIST: string[] = [
  'AuthPage (/auth) — 100% escura',
  'LobbyPage e Wizard (/lobby, /selecionar-equipe) — 100% escura (LobbyLayout + 7 steps)',
  'TeamSelectionPage (/selecionar-equipe alternativa) — 100% escura',
